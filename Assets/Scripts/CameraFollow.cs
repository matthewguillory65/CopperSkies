...
public class CameraFollow : MonoBehaviour
{
    ...
    void Update()
    {
        Vector3 BehindPos = new Vector3(Mathf.Sin(ObjectToFollow.rotation.eulerAngles.y / 180 * Mathf.PI) * Distance + ObjectToFollow.position.x, Height, Mathf.Cos(ObjectToFollow.rotation.eulerAngles.y / 180 * Mathf.PI) * Distance + ObjectToFollow.position.z);
