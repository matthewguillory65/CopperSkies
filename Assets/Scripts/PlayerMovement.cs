...
public class PlayerMovement : MonoBehaviour {
    ...
    void Move()
    {
        ...
        movevec = new Vector3(hinput * body.velocity.magnitude / MaxSpeed * UpgradeNumber, Input.GetAxis("Lift") * 5 * Time.deltaTime * 30, (vinput * PropForce + Mathf.Abs(hinput + body.angularVelocity.magnitude)) * UpgradeNumber * Time.deltaTime * 30);
